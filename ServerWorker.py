...
# receive request -> process request (SETUP, PLAY, PAUSE, TEARDOWN)
class ServerWorker:
    SETUP = 'SETUP'
    PLAY = 'PLAY'
    PAUSE = 'PAUSE'
    ...
    # sử dụng khi PLAY -> server send RTP để client giải mã -> phát video
    ...
    # sử dụng khi PLAY -> dùng hàm encode của rtpPacket để đóng gói header
    ...
    # gửi reply Rtp trong mỗi lần client send request (SETUP, PLAY, PAUSE, TEARDOWN)
