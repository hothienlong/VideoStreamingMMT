...
class Client:
    ...
    # sử dụng khi listen -> chuyển data thành image file -> truyền vào updateMovie
    ...
    # sử dụng những image file của writeFrame -> chuyển thành video = update(write(data))
    ...
    # kết nối server khi tạo 1 client mới
